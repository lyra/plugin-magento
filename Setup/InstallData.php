...
class InstallData implements InstallDataInterface
{
    ...
    public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $customerInstaller->addAttribute('customer', 'payzen_identifier', [
            'type' => 'varchar',
            'input' => 'text',
        ...
        $connection->insert(
            ...
            ['status' => 'payzen_to_validate', 'label' => 'To validate payment']
        );

        $connection->insert(
            $setup->getTable('sales_order_status_state'),
            ['status' => 'payzen_to_validate', 'state' => 'payment_review', 'is_default' => 0]
        );

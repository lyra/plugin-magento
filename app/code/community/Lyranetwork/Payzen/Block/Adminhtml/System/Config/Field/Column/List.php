...
class Lyranetwork_Payzen_Block_Adminhtml_System_Config_Field_Column_List extends Mage_Core_Block_Abstract
{
    protected function _toHtml()
    {
        $html = '<select name="'. $this->inputName . '" currentvalue="#{' . $this->columnName . '}" defaultvalue="'

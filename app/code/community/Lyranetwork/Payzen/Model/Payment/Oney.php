...
class Lyranetwork_Payzen_Model_Payment_Oney extends Lyranetwork_Payzen_Model_Payment_Abstract
{
    ...
    public function isAvailable($quote = null)
    {
        ...
        if ($quote->getCustomerId() && ! preg_match(Lyranetwork_Payzen_Helper_Util::CUST_ID_REGEX, $quote->getCustomerId())) {
            ...
            $this->_getHelper()->log(sprintf($msg, $quote->getCustomerId(), Lyranetwork_Payzen_Helper_Util::CUST_ID_REGEX), Zend_Log::WARN);
            return false;
        }
        ...
        if (! preg_match(Lyranetwork_Payzen_Helper_Util::ORDER_ID_REGEX, $quote->getReservedOrderId())) {
            ...
            $this->_getHelper()->log(sprintf($msg, $quote->getReservedOrderId(), Lyranetwork_Payzen_Helper_Util::ORDER_ID_REGEX), Zend_Log::WARN);
            return false;
        }
        ...
        foreach ($quote->getAllItems() as $item) {
            ...
            if (! preg_match(Lyranetwork_Payzen_Helper_Util::PRODUCT_REF_REGEX, $item->getProductId())) {
                ...
                $this->_getHelper()->log(sprintf($msg, $item->getProductId(), Lyranetwork_Payzen_Helper_Util::PRODUCT_REF_REGEX), Zend_Log::WARN);
                return false;
            }
        }

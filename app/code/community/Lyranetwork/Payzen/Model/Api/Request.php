...
if (! class_exists('Lyranetwork_Payzen_Model_Api_Request', false)) {

    /**
     * Class managing and preparing request parameters and HTML rendering of request.
     */
    class Lyranetwork_Payzen_Model_Api_Request
    {

        /**
         * The fields to send to the payment gateway.
         *
         * @var array[string][Lyranetwork_Payzen_Model_Api_Field]
         * @access private
         */
        ...
        {
            // Initialize encoding.
            $this->encoding = in_array(strtoupper($encoding), Lyranetwork_Payzen_Model_Api_Api::$SUPPORTED_ENCODINGS) ?
            ...
            $timestamp = time();
            $this->set('vads_trans_id', Lyranetwork_Payzen_Model_Api_Api::generateTransId($timestamp));
        ...
        {
            $this->requestParameters[$name] = new Lyranetwork_Payzen_Model_Api_Field($name, $label, $regex, $required, $length);
        ...
        /**
         * Generate signature from a list of Lyranetwork_Payzen_Model_Api_Field.
         *
         * @param array[string][Lyranetwork_Payzen_Model_Api_Field] $fields already filtered fields list
         * @param bool $hashed
         * @return string
         */
        private function generateSignature($fields, $hashed = true)
        {
            ...
            return Lyranetwork_Payzen_Model_Api_Api::sign($params, $this->getCertificate(), $this->algo, $hashed);
        }
         ...
         *
         * @return array[string][Lyranetwork_Payzen_Model_Api_Field] a list of Lyranetwork_Payzen_Model_Api_Field
         */

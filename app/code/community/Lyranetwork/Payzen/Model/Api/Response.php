...
if (! class_exists('Lyranetwork_Payzen_Model_Api_Response', false)) {

    /**
     * Class representing the result of a transaction (sent by the IPN URL or by the client return).
     */
    class Lyranetwork_Payzen_Model_Api_Response
    {
         ...
         *
         * @see Lyranetwork_Payzen_Model_Api_Api::sign
         * @var string
         */
        private $certificate;
         ...
         * @var string
         */
        private $algo = Lyranetwork_Payzen_Model_Api_Api::ALGO_SHA1;
        ...
        /**
         * Constructor for Lyranetwork_Payzen_Model_Api_Response class.
        ...
        {
            return Lyranetwork_Payzen_Model_Api_Api::sign($this->rawResponse, $this->certificate, $this->algo, $hashed);
        }
        ...
        {
            return in_array($this->transStatus, Lyranetwork_Payzen_Model_Api_Api::getSuccessStatuses()) || $this->isPendingPayment();
        }
        ...
        {
            return in_array($this->transStatus, Lyranetwork_Payzen_Model_Api_Api::getPendingStatuses());
        }
        ...
        {
            return in_array($this->transStatus, Lyranetwork_Payzen_Model_Api_Api::getCancelledStatuses());
        }
        ...
        {
            return in_array($this->transStatus, Lyranetwork_Payzen_Model_Api_Api::getToValidateStatuses());
        }
        ...
        {
            $currency = Lyranetwork_Payzen_Model_Api_Api::findCurrencyByNumCode($this->get('currency'));
        ...
        public function getOutputForGateway($case = '', $extra_message = '', $original_encoding = 'UTF-8')
        {
            ...
            $encoding = in_array(strtoupper($original_encoding), Lyranetwork_Payzen_Model_Api_Api::$SUPPORTED_ENCODINGS) ?

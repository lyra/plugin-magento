 ...
 */
class Lyra_Payzen_Block_Field_Standard_ThreedsCustgroupOptions extends Lyra_Payzen_Block_Field_CustgroupOptions
{
    public function __construct()
    {
        parent::__construct();

        // maximum amount is not necessary for 3-DS configuration.

 ...
 */
class Lyra_Payzen_Block_Field_Gift_AddedCards extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
    public function __construct()
    {
        ...
        $this->addColumn(
            ...
            array(
                ...
                'style' => 'width: 340px;',
                'size' => '20',
                'renderer' => new Lyra_Payzen_Block_Field_Gift_UploadButton
            )
        );

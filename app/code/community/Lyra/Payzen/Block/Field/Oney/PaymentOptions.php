 ...
 */
class Lyra_Payzen_Block_Field_Oney_PaymentOptions extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
    ...
    protected function _toHtml()
    {
        ...
        if ($this->getElement()->getCanUseWebsiteValue() || $this->getElement()->getCanUseDefaultValue()) {
            ...
            if ($this->getElement()->getDisabled()) {
                $script .= '
                        toggleValueElements({checked: true}, $("payment_payzen_oney_payment_options").parentNode);';
            }

            $script .= '
                        Event.observe($("payment_payzen_oney_enable_payment_options"), "change", function() {
                            toggleValueElements(
                                $("payment_payzen_oney_payment_options_inherit"),
                                $("payment_payzen_oney_payment_options").parentNode
                            );
                        });
                    });
                //]]>

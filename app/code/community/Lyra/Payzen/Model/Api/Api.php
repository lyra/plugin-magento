...
if (! class_exists('Lyra_Payzen_Model_Api_Api', false)) {
     ...
     */
    class Lyra_Payzen_Model_Api_Api
    {
        ...
        public static function getSupportedCurrencies()
        {
            ...
            foreach ($currencies as $currency) {
                $payzen_currencies[] = new Lyra_Payzen_Model_Api_Currency($currency[0], $currency[1], $currency[2]);
            }
         ...
         *
         * @param string $alpha3
         * @return Lyra_Payzen_Model_Api_Currency
         */
        public static function findCurrencyByAlphaCode($alpha3)
        {
            ...
            foreach ($list as $currency) {
                /**
                 * @var Lyra_Payzen_Model_Api_Currency $currency
                 */
        ...
        public static function getCurrencyNumCode($alpha3)
        {
            ...
            return ($currency instanceof Lyra_Payzen_Model_Api_Currency) ? $currency->getNum() : null;
        }

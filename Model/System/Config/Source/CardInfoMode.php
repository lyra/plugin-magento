...
class CardInfoMode implements \Magento\Framework\Option\ArrayInterface
{
    ...
    {
        return [
            ['value' => '1', 'label' => __('Card data entry on payment platform')],
            ['value' => '2', 'label' => __('Card type selection on merchant site')],
            ['value' => '3', 'label' => __('Card data entry on merchant site')]
        ];
    }
}
